	...
	<div class="btn-card">
		<div class="card row">
			<div class="card-action cyan white-text btn-group">
               	...
               	<button class="btn waves-effect waves-light  pink accent-2 white-text btn-suit right action-more" type="button"><i class="mdi-image-details"></i></button>
                ...
                <button class="btn waves-effect waves-light  pink accent-2 white-text btn-suit right query-more" type="button"><i class="mdi-action-search"></i></button>
	          	<div class="action-more-div btn-group hide">
	                <button class="btn waves-effect waves-light pink accent-2 white-text btn-suit right btn-delete" data-url="admin/resource/delete" type="button">删除 <i class="mdi-content-remove"></i></button>
	                <button class="btn waves-effect waves-light pink accent-2 white-text btn-suit right btn-update" type="button">修改 <i class="mdi-content-create"></i></button>
	          	</div>
						...
						<form id="pageQueryForm" class="col s12">
							<div class="row">
								...
								<div class="input-field col s12 m12 l3 btn-group">
									<button class="btn btn-suit yellow white-text darken-4 waves-effect waves-light right resetForm" type="button">
