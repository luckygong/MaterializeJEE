...
<div class="container">
                	...
                	<form id="form" class="col s12 right-alert" method="post" enctype="multipart/form-data">
                   		<div class="row">
							...
							<div id="refIdDiv" class="hide">
                      			<div class="input-field col s8 m4 s4">
                        			...
                        			<input id="name" name="refName" data-bind-json-path="/employee" data-bind-name="name" type="text" disabled>
                        			<input id="refId" name="refId" data-bind-json-path="/" data-bind-name="refId" class="hide" type="text" class="validate">
                   		...
                   		<div class="row">
                     			<div class="input-field col s12 m6 s6">
                       			...
                       			<input id="username" name="username"  data-bind-json-path="/" data-bind-name="username" type="text" class="validate">
                   		...
                   		<div class="row">
                     			<div class="input-field col s12 m6 s6">
                       			...
                       			<input id="nikeName" name="nikeName"  data-bind-json-path="/" data-bind-name="nikeName" type="text" class="validate">
                       			<label for="nikeName">昵称</label>
                     			</div>
                     			<div class="input-field col s12 m6 s6">
                     				<i class="mdi-action-visibility prefix"></i>
                       			<input id="realName" name="realName"  data-bind-json-path="/" data-bind-name="realName" type="text" class="validate">
                   		...
                   		<div class="row">
                     			<div class="input-field col s12 m6 s6">
                       			...
                       			<input id="phone" name="phone"  data-bind-json-path="/" data-bind-name="phone" type="text" class="validate">
                       			<label for="phone">手机</label>
                     			</div>
                     			<div class="input-field col s12 m6 s6">
                     				<i class="mdi-communication-email prefix"></i>
                       			<input id="email" name="email"  data-bind-json-path="/" data-bind-name="email" type="text" class="validate">
                   		...
                   		<div class="row">
								...
								<select id="sex" name="sex"  data-bind-json-path="/" data-bind-name="sex" class="browser-default validate"></select>
								<label for="sex"></label>
							</div>
                   		</div>
                   		<div class="row">
                   		...
                   		<div class="row">
                          	<div class="input-field col s12">
                            	...
                            	<button class="btn waves-effect waves-light grey goBack" type="button">返回
	...
	<div id="modalUserSelect" class="modal">
	...
	$(document).ready(function() {
		...
		$("#form").validate({
			submitHandler:function(form){
				...
				blockUI.block();
				$("#form").ajaxSubmit({
					url: getProjectName()+"/admin/user/update",
					dataType: "json",
					success: function(data){
				  		blockUI.unblock();
						if(data.status==1){
	...
	function initPageTable(queryResult) {
		...
		$("#chooseEm").on('click',function(){
			...
			if(select.length>0){
				...
				$("#refId").val(id);
				$("#name").val(name);
				$("#name").closest(".input-field").children("label").addClass("active");
			}
			$(".modal-close").click();
		});
