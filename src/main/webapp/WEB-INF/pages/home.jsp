...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/js/plugins/jvectormap/jquery-jvectormap.css" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="${pageContext.request.contextPath}/assets/js/plugins/chartist-js/chartist.min.css" type="text/css" rel="stylesheet" media="screen,projection">
</head>
    ...
    <div id="card-widgets">
        <div class="row">
            <div class="col s12 m12 l4">
                <ul class="task-card collection with-header">
            ...
            <div class="col s12 m6 l4">
                <div id="profile-card" class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img class="activator" src="${pageContext.request.contextPath}/assets/images/user-bg.jpg" alt="user background">
                    </div>
                    <div class="card-content">
                        <img src="${pageContext.request.contextPath}/assets/images/avatar.jpg" alt="" class="circle responsive-img activator card-profile-image">
        ...
        <div class="row">
            ...
            <div class="col s12 m12 l4">
                ...
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img src="${pageContext.request.contextPath}/assets/images/gallary/30.jpg" alt="blog-img">
                    </div>
                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                          <div class="col s2">
                            <img src="${pageContext.request.contextPath}/assets/images/avatar.jpg" alt="" class="circle responsive-img valign profile-image">
                          </div>
                ...
                <div class="product-card">
                    <div class="card">
                        <div class="card-image waves-effect waves-block waves-light">
                            ...
                            <img src="${pageContext.request.contextPath}/assets/images/gallary/33.jpg" alt="product-img">
                        </div>
                        <ul class="card-action-buttons">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col s4 no-padding">
                                    <a href=""></a><img src="${pageContext.request.contextPath}/assets/images/amazon.jpg" alt="amazon" class="responsive-img">
...
<!-- chartist -->
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/chartist-js/chartist.min.js"></script>   
<!-- chartjs -->
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/chartjs/chart.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/chartjs/chart-script.js"></script>
<!-- sparkline -->
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/sparkline/sparkline-script.js"></script>
<!--jvectormap-->
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/plugins/jvectormap/vectormap-script.js"></script>

<script type="text/javascript">
$(document).ready(function() {
	Message.info({message:"test alert",time:3});
});
</script>
