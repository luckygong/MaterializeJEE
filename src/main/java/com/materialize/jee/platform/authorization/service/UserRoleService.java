 ...
 * @Description: TODO(UserRoleService service层)
 */
public interface UserRoleService {
	 ...
	 * @return  返回根据主键查询的对象
	 */
	UserRole get(java.lang.Long id);
	 ...
	 * @return 返回根据条件查询的数据
	 */
	Page<UserRole> findPage(Integer pageNo, Integer pageSize,Map<String,Object> entityMap);
